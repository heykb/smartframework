...
public class PropsUtil {
    ...
    public static Properties loadProps(String propsPath){
        return loadProps(propsPath,DEFAULT_ENCODING);
    }
    ...
    public static void main(String[] args) {
        //初始化属性文件
        PropsUtil propsUtil = new PropsUtil("smart");
        //获得Map集合
        Map<String, String> map = propsUtil.loadPropsToMap();
        //根据key获得某个值
        String string = propsUtil.getString("smart.properties");
        System.out.println(string);
        System.out.println(map.get("smart.framework.jdbc.driver"));
    }
}
